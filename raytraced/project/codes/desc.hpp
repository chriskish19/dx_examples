...
namespace core {
	...
	inline const character* uninitialized_description = ROS("core code: uninitialized | message: code is uninitialized, means the core code enum was not explicitly initialized. Default setting.");
